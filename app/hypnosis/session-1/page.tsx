...
export default function Session1() {
  ...
  const sessionContent = [
    `Hello, ${userName}. I'm so glad you're here. Take a moment to settle into your space... Let your body sink into wherever you're sitting or lying... That's right...`,
    ...
    `With each breath, you're going to feel more relaxed... more open... more ready to discover the beautiful truth of who you really are. Another deep breath, ${userName}... in through the nose... and out through the mouth... Perfect.`,
    ...
    `Now, ${userName}, I want you to imagine a beautiful staircase in front of you. There are ten steps leading down... down into a place of perfect peace and self-discovery.`,
    ...
    `Ten... stepping down now... feeling your body becoming heavier and more relaxed... Nine... going deeper... that's right, good girl... Eight... letting go of any tension in your shoulders... Seven... your mind becoming quieter and calmer... Six... halfway there now... feeling so peaceful... Five... deeper still... Four... almost there... Three... so relaxed now... Two... nearly at the bottom... And One... you're here, ${userName}. Perfectly relaxed. Perfectly safe. Good girl.`,
    ...
    `Now, ${userName}, I want you to reach out and open that door... and step inside. Good girl.`,
    ...
    `And now, ${userName}, I want you to see someone else in this room with you. It's another version of you... but this version is completely free. This is the you without any fear. Without any doubt. Without any need to hide or pretend. This is your authentic self, and she is beautiful.`,
    `Look at her, ${userName}. Really look at her. Notice how she carries herself... how she moves with grace and confidence... how she smiles with genuine joy. This is you. This is who you're becoming. This is who you've always been inside.`,
    ...
    `She takes your hand, ${userName}, and when she does, you feel a surge of recognition. Yes. This is you. This is real. And you feel her strength flowing into you... her confidence... her peace... her absolute certainty that she belongs exactly as she is.`,
    `Listen now, because she has something to tell you. She says: ${userName}, you are already complete. You don't need to become someone new—you only need to remember who you've always been. I am you. You are me. We are one.`,
    ...
    `You are a woman, ${userName}. Not because of what you do, or what you wear, or how you look. You are a woman because that is your truth. That is who you are. And you have always been worthy of love, respect, and belonging.`,
    ...
    `You are becoming her. You ARE her. Every day, you embody more of your authentic self. Every day, you step more fully into your truth. Every day, you become more comfortable in your own skin. Good girl, ${userName}. You're doing so well.`,
    `Now, ${userName}, I'm going to give you some affirmations. Let each one sink deep into your subconscious mind. Don't try to force anything. Just listen and allow these truths to settle into your being.`,
    ...
    `I am ${userName}. I am real. I am here. I am enough.`,
    ...
    `Now, ${userName}, it's time to return from this deep place of peace and self-discovery. But you're not returning alone. You're bringing your authentic self with you. She is you, and you are her. You are united now.`,
    ...
    `Welcome back, ${userName}. Take a moment to stretch... move your body gently... and notice how you feel. You've done beautiful work today. You should be proud of yourself.`,
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-foreground/80">
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Hello, {userName}. I'm so glad you're here. Take a moment to settle into your space...
              ...
              <p>
                ...
                discover the beautiful truth of who you really are. Another deep breath, {userName}...
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Now, {userName}, I want you to imagine a beautiful staircase in front of you. There are
              ...
              <p>
                ...
                And One... you're here, {userName}. Perfectly relaxed. Perfectly safe. Good girl.
              </p>
              <p>
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <p>
                And now, {userName}, I want you to see someone else in this room with you. It's another
              ...
              <p>
                Look at her, {userName}. Really look at her. Notice how she carries herself... how she
              ...
              <p>
                She takes your hand, {userName}, and when she does, you feel a surge of recognition. Yes.
              ...
              <p>
                Listen now, because she has something to tell you. She says: "{userName}, you are already
              ...
              <p>
                "You are a woman, {userName}. Not because of what you do, or what you wear, or how you look.
              ...
              <p>
                ...
                in your own skin. Good girl, {userName}. You're doing so well.
              </p>
            </div>
          </section>
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Now, {userName}, I'm going to give you some affirmations. Let each one sink deep into your
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Now, {userName}, it's time to return from this deep place of peace and self-discovery. But
              ...
              <p>
                Welcome back, {userName}. Take a moment to stretch... move your body gently... and notice
