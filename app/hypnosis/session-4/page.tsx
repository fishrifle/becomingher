        ...
        <div className="prose prose-lg max-w-none space-y-6 text-foreground/80">
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Hello, {userName}. Welcome to this session on confidence and self-love. These aren't just
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Close your eyes now, {userName}, and imagine you're standing at the base of a beautiful
              ...
              <p>
                ...
                yourself. Keep climbing, {userName}. You're doing beautifully.
              </p>
            </div>
          </section>
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                You've reached a plateau on the mountain now, {userName}. There's a beautiful temple here,
              ...
              <p>
                ...
                simply because you exist. You are worthy simply because you ARE. {userName}, you are the
              ...
              <p>
                ...
                inherent worth, your dignity, your power. You are royalty, {userName}. You are a queen.
              ...
              <p>
                A mirror appears in front of you now. Look into it, {userName}. See yourself sitting on your
              ...
              <p>
                The reflection speaks to you now. She says: "{userName}, I am so proud of you. Look at
              ...
              <p>
                "I love you, {userName}. I love your kindness. I love your resilience. I love your vulnerability
              ...
              <p>
                Feel these words sinking deep into your heart, {userName}. This is your own self-love speaking
              ...
              <p>
                ...
                that is enough." Good girl, {userName}. Feel the power in those words.
              </p>
              <p>
              ...
              <p>
                ...
                {userName}. You are a woman. You are confident. You are worthy. You are loved. And you are
                enough.
              </p>
              <p>
                Stand up from your throne now, {userName}. The crown stays on your head. The beautiful
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Stand in the center of your temple, {userName}, and speak these affirmations aloud in your
              ...
              <p className="font-semibold text-primary">
                I am {userName}, and I am more than enough.
              </p>
              <p>
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Walk out of your temple now, {userName}, still wearing your crown, still carrying your
              ...
              <p>
                Welcome back, {userName}. You are magnificent. You are worthy. You are loved. And most
