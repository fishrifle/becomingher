        ...
        <div className="prose prose-lg max-w-none space-y-6 text-foreground/80">
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Welcome back, {userName}. I'm so glad you're here for this journey into your feminine energy.
              ...
              <p>
                ...
                always been there, {userName}. It's always been part of you. Today, we're simply going to
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Close your eyes now, {userName}, and imagine you're standing at the edge of a beautiful garden.
              ...
              <p>
                You feel drawn to this fountain, {userName}. You know that its waters are meant for you.
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                There's a comfortable seat beside the fountain, {userName}. Sit down there now... feeling
              ...
              <p>
                Bring the water to your heart, {userName}. Feel it sinking into your chest... spreading
              ...
              <p>
                ...
                new possibilities into the world. Good girl, {userName}.
              </p>
              <p>
              ...
              <p>
                And now, {userName}, I want you to stand up. In this garden, by this fountain, stand up and
              ...
              <p>
                ...
                You are emotional AND wise. All of these things exist within you, {userName}, and they make
              ...
              <p>
                ...
                and look at yourself. Really look. See the woman standing before you. See {userName} in her
                full feminine power. See the grace in your posture, the softness in your features, the
                strength in your eyes.
              </p>
              <p>
                This is you, {userName}. This is who you are when all barriers are removed. This is your
              ...
              <p>
                Take one more scoop of the glowing water from the fountain, {userName}. Drink it this time.
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                Sit by the fountain one more time, {userName}, and let these affirmations sink deep into
              ...
              <p className="font-semibold text-primary">
                I am {userName}, and I am beautifully, perfectly feminine.
              </p>
              <p>
          ...
          <section className="bg-accent/20 border border-primary/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <p>
                It's time to leave this beautiful garden, {userName}, but you're taking its gifts with you.
              ...
              <p>
                Welcome back, {userName}. You are a beautiful, feminine woman, and that truth shines through
